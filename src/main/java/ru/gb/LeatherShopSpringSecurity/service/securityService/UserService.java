package ru.gb.LeatherShopSpringSecurity.service.securityService;
...
import ru.gb.LeatherShopSpringSecurity.repository.securityRep.UserRepository;

import java.util.List;
import java.util.Optional;

/**
 * Класс реализующий взаимодействие с репозиторием по пользователям
 */
@Service
@AllArgsConstructor
